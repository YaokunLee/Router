    ...
    void transform(TransformInvocation transformInvocation)
        ...
        transformInvocation.inputs.each {
            ...
            it.directoryInputs.each { directoryInput ->
                ...
                com.lyk.router.gradle.FileUtils.copyFolder(directoryInput.file.absolutePath, destDir.absolutePath)
            }
            ...
            it.jarInputs.each { jarInput ->
                ...
                com.lyk.router.gradle.FileUtils.copyFile(jarInput.file, dest)
            }
        }
